...
class EntityClassifier:
    ...
    def __init__(self):
        ...
        self.type_keywords = {
            "company": [
                "company", "corporation", "corp", "inc", "llc", "ltd", "startup",
                "firm", "enterprise", "business", "organization", "co",
                "technologies", "systems", "solutions", "labs", "ventures"
            ],
            "person": [
                "founder", "ceo", "cto", "president", "director", "executive",
                "manager", "lead", "head", "chief", "officer", "vp",
                "investor", "partner", "co-founder"
            ],
            "investor": [
                "capital", "ventures", "partners", "fund", "investments",
                "investors", "group", "holdings", "management", "vc",
                "venture capital", "private equity", "angel"
            ],
            "technology": [
                "ai", "artificial intelligence", "machine learning", "blockchain",
                "cloud", "software", "platform", "system", "algorithm",
                "api", "framework", "protocol", "language", "tool"
            ],
            "product": [
                "app", "application", "service", "tool", "platform", "software",
                "system", "product", "solution", "device", "service"
            ],
            "location": [
                "city", "state", "country", "region", "area", "district",
                "valley", "bay", "coast", "island", "mountains"
            ],
            "event": [
                "conference", "summit", "event", "meeting", "show", "festival",
                "awards", "competition", "hackathon", "workshop", "seminar"
            ]
        }
    
    def refine_classification(self, entity: Dict, context: str = "") -> Tuple[str, float]:
        """
    ...
    def _apply_heuristics(self, name: str, description: str, scores: Dict) -> Dict:
        ...
        # Location detection
        location_indicators = ["located", "based", "headquarters", "headquarters", "city", "country"]
    ...
    def disambiguate_entity(self, entity: Dict, co_occurring_entities: List[Dict]) -> Tuple[str, float]:
        """
        ...
        if name in ["ford", "gates", "jobs", "bezos", "musk"]:
            ...
            company_indicators = sum(1 for e in co_occurring_entities 
                                   if e.get("type", "").lower() == "company")
            person_indicators = sum(1 for e in co_occurring_entities 

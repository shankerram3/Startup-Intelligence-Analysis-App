...
def main():
    ...
    try:
        ...
        print("  python -c \"from utils.aura_graph_analytics import AuraGraphAnalytics; gds = AuraGraphAnalytics(); gds.create_session(); result = gds.detect_communities('leiden'); print(result)\"")

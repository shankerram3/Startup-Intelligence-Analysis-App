...
class GraphRAGClient:
    ...
    # Query methods
    def query(self, question: str, return_context: bool = False, use_llm: bool = True) -> Dict:
    ...
    def multi_hop_reasoning(self, question: str, max_hops: int = 3) -> Dict:
        ...
        return self._post("/query/multi-hop", {
            "question": question,
            "max_hops": max_hops
        })

    # Search methods
    def semantic_search(self, query: str, top_k: int = 10, entity_type: str = None) -> Dict:
    ...
    def hybrid_search(self, query: str, top_k: int = 10, semantic_weight: float = 0.7) -> Dict:
        """Hybrid search combining semantic and keyword"""
        return self._post("/search/hybrid", {
            "query": query,
            "top_k": top_k,
    ...
    def compare_entities(self, entity1: str, entity2: str) -> Dict:
        ...
        return self._post("/entity/compare", {
            "entity1": entity1,
            "entity2": entity2
        })
...
def main():
    ...
    try:
        ...
        print(f"Graph nodes: {sum(c['count'] for c in health['graph_stats']['node_counts'])}")
        ...
        results = client.semantic_search("artificial intelligence", top_k=5, entity_type="Company")
